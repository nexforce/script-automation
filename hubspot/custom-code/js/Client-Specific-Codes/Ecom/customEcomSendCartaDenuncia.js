...
async function sendCartaDenuncia(data) {
  try {
    ...
    const payload = {
      ...
      signers: [
        {
          name: "Paulo Roberto Duarte Toledo",
          email: "paulo@ecomenergia.com.br",
          auth_mode: "assinaturaTela",
          send_automatic_email: true,
        },
        {
          name: "Marcio Valerio Sant'Anna",
          email: "marcio@ecomenergia.com.br",
          auth_mode: "assinaturaTela",
          send_automatic_email: true,
        },
      ],
      ...
      created_by: data.e_mail_do_representante_legal,
